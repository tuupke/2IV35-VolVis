 ...
 * @author michel
 */
public class MIPRenderer extends Renderer implements TFChangeListener {
    ...
    public MIPRenderer(Visualization v) {
    ...
    void slicer(double[] viewMatrix) {
        ...
        for (int j = 1; j < image.getHeight()-1; j += 2) {
            for (int i = 1; i < image.getWidth()-1; i += 2) {
                int val = 0;
